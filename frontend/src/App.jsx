...
import { Camera, Upload, CheckCircle, ScanLine, X, History, Clock, Trash2, LogOut } from 'lucide-react';
                ...
                <div className="flex items-center justify-between mb-12 opacity-80 w-full">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button 
                            ...
                            className="p-2 rounded-full transition-colors z-30 hover:bg-red-500/10 hover:text-red-400 text-white"
                            title="Đăng xuất"
                        >
                            <LogOut size={22} />
                        </button>
