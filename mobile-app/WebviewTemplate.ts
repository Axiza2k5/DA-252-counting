...
<script>
    ...
    async function initModel() {
        ...
        try {
            // baseUrl = file:///android_asset/ nên fetch tương đối sẽ tìm file tại đó
            ...
            window.ReactNativeWebView.postMessage(JSON.stringify({
                type: 'ERROR',
                message: 'Model load: ' + (e.name || '') + ' ' + (e.message || e.toString())
            }));
        }
    }
    ...
    // DOM sẵn sàng → báo RN + bắt đầu load model ngay
